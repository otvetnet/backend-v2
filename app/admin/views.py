...
class SurveyResponseView(ModelView):
    ...
    fields = [
        ...
        IntegerField("g1_total", label="Итого игра 1"),
        ...
        IntegerField("g2_total", label="Итого игра 2"),
        ...
        IntegerField("g3_total", label="Итого игра 3"),
        ...
        IntegerField("g4_total", label="Итого игра 4"),
        ...
        IntegerField("g5_total", label="Итого игра 5"),
        IntegerField("games_1_5_total", label="Итог по играм"),
        ...
        IntegerField("g6_total", label="Шкала лжи"),
        IntegerField("games_total", label="Общий итог"),
